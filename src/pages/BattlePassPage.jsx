...
function BattlePassPage() {
  ...
  const images = [
    battlePass1, battlePass2, battlePass3, battlePass4, battlePass5,
    battlePass6, battlePass7, battlePass8, battlePass9, battlePass10,
    battlePass11, battlePass12, battlePass13, battlePass14, battlePass15,
    battlePass16, battlePass17, battlePass18
  ]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button 
                  variant="outline" 
                  className="border-purple-400 text-purple-400 hover:bg-purple-400 hover:text-slate-900 px-8 py-4 text-lg rounded-full transition-all duration-300"
                >
              ...
              <div className="flex justify-center mt-6 space-x-2 overflow-x-auto pb-2 px-4 sm:px-0 scrollbar-hide">
